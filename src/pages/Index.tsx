    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-1.5 mb-8">
              ...
              <span className="text-sm font-medium text-primary">
                Facilite sua vida financeira com IA
              </span>
            </div>
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold leading-tight mb-6">
              Suas finanças no
              <br />
              <span className="text-emerald-400">piloto automático</span>
            </h1>
      ...
      <footer className="border-t border-border/20 py-8 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <DollarSign className="w-5 h-5 text-primary" />
            <span className="font-display font-bold text-primary">SICOFI</span>
          </div>
